...
_ASN1_PATH = Path(__file__).resolve().parents[3] / "tests" / "data" / "asn1_specs" / "rrc-15.6.0.asn1"
_ASN1_EXPANDED_PATH = Path(__file__).resolve().parents[3] / "tests" / "data" / "asn1_specs" / "rrc-15.6.0-expanded.asn1"
