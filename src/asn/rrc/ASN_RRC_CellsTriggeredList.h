...
typedef enum ASN_RRC_CellsTriggeredList__Member_PR {
	...
	ASN_RRC_CellsTriggeredList__Member_PR_physCellIdUTRA_FDD_r16
...
typedef struct ASN_RRC_CellsTriggeredList__Member {
	...
	union ASN_RRC_CellsTriggeredList__Member_u {
		ASN_RRC_PhysCellId_t	 physCellId;
		ASN_RRC_EUTRA_PhysCellId_t	 physCellIdEUTRA;
		ASN_RRC_PhysCellIdUTRA_FDD_r16_t	 physCellIdUTRA_FDD_r16;
	} choice;
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} ASN_RRC_CellsTriggeredList__Member;

/* CellsTriggeredList */
typedef struct ASN_RRC_CellsTriggeredList {
	A_SEQUENCE_OF(ASN_RRC_CellsTriggeredList__Member) list;
