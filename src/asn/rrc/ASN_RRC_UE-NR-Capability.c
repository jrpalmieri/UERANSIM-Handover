...
static asn_per_constraints_t asn_PER_memb_ASN_RRC_lateNonCriticalExtension_constr_16 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
...
static asn_TYPE_member_t asn_MBR_ASN_RRC_UE_NR_Capability_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct ASN_RRC_UE_NR_Capability, lateNonCriticalExtension),
		...
		0,
		{ 0, &asn_PER_memb_ASN_RRC_lateNonCriticalExtension_constr_16,  memb_ASN_RRC_lateNonCriticalExtension_constraint_1 },
		0, 0, /* No default value */
