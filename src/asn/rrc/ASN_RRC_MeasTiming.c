...
asn_TYPE_member_t asn_MBR_ASN_RRC_MeasTiming_1[] = {
	{ ATF_POINTER, 3, offsetof(struct ASN_RRC_MeasTiming, frequencyAndTiming),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct ASN_RRC_MeasTiming, ssb_ToMeasure),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	...
	{ ATF_POINTER, 1, offsetof(struct ASN_RRC_MeasTiming, physCellId),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_ASN_RRC_MeasTiming_oms_1[] = { 0, 1, 2 };
...
static const asn_TYPE_tag2member_t asn_MAP_ASN_RRC_MeasTiming_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* ssb-ToMeasure */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* physCellId */
};
