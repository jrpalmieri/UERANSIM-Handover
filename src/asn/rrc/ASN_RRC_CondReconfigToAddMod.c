...
static int
memb_ASN_RRC_condExecutionPriority_r17_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_memb_ASN_RRC_condExecutionPriority_r17_constr_8 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 7,  7,  1,  128 },
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0
};
...
asn_TYPE_member_t asn_MBR_ASN_RRC_CondReconfigToAddMod_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct ASN_RRC_CondReconfigToAddMod, condExecutionCond),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct ASN_RRC_CondReconfigToAddMod, condRRCReconfig),
	...
	{ ATF_POINTER, 2, offsetof(struct ASN_RRC_CondReconfigToAddMod, condExecutionCondSCG),
	...
	{ ATF_POINTER, 1, offsetof(struct ASN_RRC_CondReconfigToAddMod, condExecutionPriority_r17),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_ASN_RRC_condExecutionPriority_r17_constr_8,
		  memb_ASN_RRC_condExecutionPriority_r17_constraint_1 },
		0, 0,
		"condExecutionPriority-r17"
		},
...
static const int asn_MAP_ASN_RRC_CondReconfigToAddMod_oms_1[] = { 1, 2, 3, 4, 5 };
...
static const asn_TYPE_tag2member_t asn_MAP_ASN_RRC_CondReconfigToAddMod_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* condExecutionPriority-r17 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }  /* condTriggerConfig-r16 */
};
