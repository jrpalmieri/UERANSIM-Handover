...
typedef enum ASN_RRC_MRDC_Parameters__dynamicPowerSharingENDC {
	ASN_RRC_MRDC_Parameters__dynamicPowerSharingENDC_supported	= 0
} e_ASN_RRC_MRDC_Parameters__dynamicPowerSharingENDC;
...
typedef enum ASN_RRC_MRDC_Parameters__dualPA_Architecture {
	ASN_RRC_MRDC_Parameters__dualPA_Architecture_supported	= 0
} e_ASN_RRC_MRDC_Parameters__dualPA_Architecture;
typedef enum ASN_RRC_MRDC_Parameters__intraBandENDC_Support {
	ASN_RRC_MRDC_Parameters__intraBandENDC_Support_non_contiguous	= 0,
	ASN_RRC_MRDC_Parameters__intraBandENDC_Support_both	= 1
} e_ASN_RRC_MRDC_Parameters__intraBandENDC_Support;
typedef enum ASN_RRC_MRDC_Parameters__ul_TimingAlignmentEUTRA_NR {
	ASN_RRC_MRDC_Parameters__ul_TimingAlignmentEUTRA_NR_required	= 0
} e_ASN_RRC_MRDC_Parameters__ul_TimingAlignmentEUTRA_NR;
...
/* extern asn_TYPE_descriptor_t asn_DEF_ASN_RRC_dynamicPowerSharingENDC_4;	// (Use -fall-defs-global to expose) */
...
/* extern asn_TYPE_descriptor_t asn_DEF_ASN_RRC_dualPA_Architecture_20;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_ASN_RRC_intraBandENDC_Support_22;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_ASN_RRC_ul_TimingAlignmentEUTRA_NR_25;	// (Use -fall-defs-global to expose) */
...
extern asn_TYPE_member_t asn_MBR_ASN_RRC_MRDC_Parameters_1[10];
