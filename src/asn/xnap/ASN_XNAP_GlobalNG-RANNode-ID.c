...
asn_TYPE_member_t asn_MBR_ASN_XNAP_GlobalNG_RANNode_ID_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct ASN_XNAP_GlobalNG_RANNode_ID, choice.choice_extension),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ASN_XNAP_ProtocolIE_Single_Container_14199P25,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"choice-extension"
...
static const asn_TYPE_tag2member_t asn_MAP_ASN_XNAP_GlobalNG_RANNode_ID_tag2el_1[] = {
...
asn_CHOICE_specifics_t asn_SPC_ASN_XNAP_GlobalNG_RANNode_ID_specs_1 = {
