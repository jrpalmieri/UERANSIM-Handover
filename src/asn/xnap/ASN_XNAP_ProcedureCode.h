...
#define ASN_XNAP_ProcedureCode_id_rachIndication	((ASN_XNAP_ProcedureCode_t)50)
#define ASN_XNAP_ProcedureCode_id_dataCollectionReportingInitiation	((ASN_XNAP_ProcedureCode_t)51)
#define ASN_XNAP_ProcedureCode_id_dataCollectionReporting	((ASN_XNAP_ProcedureCode_t)52)
