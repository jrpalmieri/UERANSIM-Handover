...
asn_TYPE_descriptor_t asn_DEF_ASN_XNAP_nextPagingAreaScope_4 = {
	...
	{ 0, &asn_PER_type_ASN_XNAP_nextPagingAreaScope_constr_4, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_ASN_XNAP_RANPagingAttemptInfo_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_RANPagingAttemptInfo, pagingAttemptCount),
		...
		0,
		{ 0, &asn_PER_memb_ASN_XNAP_pagingAttemptCount_constr_2,  memb_ASN_XNAP_pagingAttemptCount_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_RANPagingAttemptInfo, intendedNumberOfPagingAttempts),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_ASN_XNAP_intendedNumberOfPagingAttempts_constr_3,  memb_ASN_XNAP_intendedNumberOfPagingAttempts_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct ASN_XNAP_RANPagingAttemptInfo, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ASN_XNAP_ProtocolExtensionContainer_14246P400,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
