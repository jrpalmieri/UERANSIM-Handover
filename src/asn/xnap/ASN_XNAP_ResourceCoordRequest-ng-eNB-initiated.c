...
asn_TYPE_descriptor_t asn_DEF_ASN_XNAP_listofE_UTRACells_4 = {
	...
	{ 0, &asn_PER_type_ASN_XNAP_listofE_UTRACells_constr_4, SEQUENCE_OF_constraint },
	asn_MBR_ASN_XNAP_listofE_UTRACells_4,
	1,	/* Single element */
	&asn_SPC_ASN_XNAP_listofE_UTRACells_specs_4	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_ASN_XNAP_ResourceCoordRequest_ng_eNB_initiated_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct ASN_XNAP_ResourceCoordRequest_ng_eNB_initiated, listofE_UTRACells),
		...
		0,
		{ 0, &asn_PER_memb_ASN_XNAP_listofE_UTRACells_constr_4,  memb_ASN_XNAP_listofE_UTRACells_constraint_1 },
		0, 0, /* No default value */
		"listofE-UTRACells"
		},
	{ ATF_POINTER, 1, offsetof(struct ASN_XNAP_ResourceCoordRequest_ng_eNB_initiated, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ASN_XNAP_ProtocolExtensionContainer_14246P40,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static const int asn_MAP_ASN_XNAP_ResourceCoordRequest_ng_eNB_initiated_oms_1[] = { 2, 3 };
static const ber_tlv_tag_t asn_DEF_ASN_XNAP_ResourceCoordRequest_ng_eNB_initiated_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ASN_XNAP_ResourceCoordRequest_ng_eNB_initiated_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_ASN_XNAP_ResourceCoordRequest_ng_eNB_initiated_specs_1 = {
