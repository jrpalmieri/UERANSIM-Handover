...
static asn_TYPE_member_t asn_MBR_ASN_XNAP_PDUSessionResourceChangeRequiredInfo_SNterminated_1[] = {
...
static int asn_MAP_ASN_XNAP_PDUSessionResourceChangeRequiredInfo_SNterminated_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_ASN_XNAP_PDUSessionResourceChangeRequiredInfo_SNterminated_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_ASN_XNAP_PDUSessionResourceChangeRequiredInfo_SNterminated_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dataforwardinginfofromSource at 10052 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* iE-Extensions at 10053 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ASN_XNAP_PDUSessionResourceChangeRequiredInfo_SNterminated_specs_1 = {
