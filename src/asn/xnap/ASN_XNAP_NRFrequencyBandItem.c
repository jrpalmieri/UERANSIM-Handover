...
static asn_TYPE_member_t asn_MBR_ASN_XNAP_NRFrequencyBandItem_1[] = {
...
static int asn_MAP_ASN_XNAP_NRFrequencyBandItem_oms_1[] = { 1, 2 };
static ber_tlv_tag_t asn_DEF_ASN_XNAP_NRFrequencyBandItem_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_ASN_XNAP_NRFrequencyBandItem_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* nr-frequency-band at 9028 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* supported-SUL-Band-List at 9029 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* iE-Extension at 9030 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ASN_XNAP_NRFrequencyBandItem_specs_1 = {
