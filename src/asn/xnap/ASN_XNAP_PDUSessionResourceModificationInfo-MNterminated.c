...
static asn_TYPE_member_t asn_MBR_ASN_XNAP_PDUSessionResourceModificationInfo_MNterminated_1[] = {
...
static int asn_MAP_ASN_XNAP_PDUSessionResourceModificationInfo_MNterminated_oms_1[] = { 1, 2, 3, 4 };
static ber_tlv_tag_t asn_DEF_ASN_XNAP_PDUSessionResourceModificationInfo_MNterminated_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_ASN_XNAP_PDUSessionResourceModificationInfo_MNterminated_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* pduSessionType at 9972 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* dRBsToBeSetup at 9973 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* dRBsToBeModified at 9974 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* dRBsToBeReleased at 9975 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* iE-Extensions at 9976 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ASN_XNAP_PDUSessionResourceModificationInfo_MNterminated_specs_1 = {
