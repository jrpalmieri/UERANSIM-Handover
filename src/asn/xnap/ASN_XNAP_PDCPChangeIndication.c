...
static asn_per_constraints_t asn_PER_type_ASN_XNAP_PDCPChangeIndication_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_ASN_XNAP_from_S_NG_RAN_node_2 = {
	...
	{ 0, &asn_PER_type_ASN_XNAP_from_S_NG_RAN_node_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_ASN_XNAP_from_M_NG_RAN_node_6 = {
	...
	{ 0, &asn_PER_type_ASN_XNAP_from_M_NG_RAN_node_constr_6, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_ASN_XNAP_PDCPChangeIndication_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct ASN_XNAP_PDCPChangeIndication, choice.choice_extension),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ASN_XNAP_ProtocolIE_Single_Container_14199P52,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"choice-extension"
...
asn_TYPE_descriptor_t asn_DEF_ASN_XNAP_PDCPChangeIndication = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_ASN_XNAP_PDCPChangeIndication_constr_1, CHOICE_constraint },
