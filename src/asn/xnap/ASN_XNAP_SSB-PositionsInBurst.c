...
static asn_per_constraints_t asn_PER_type_ASN_XNAP_SSB_PositionsInBurst_constr_1 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_ASN_XNAP_SSB_PositionsInBurst_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_SSB_PositionsInBurst, choice.shortBitmap),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_ASN_XNAP_shortBitmap_constr_2,  memb_ASN_XNAP_shortBitmap_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_SSB_PositionsInBurst, choice.mediumBitmap),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_ASN_XNAP_mediumBitmap_constr_3,  memb_ASN_XNAP_mediumBitmap_constraint_1 },
		0, 0, /* No default value */
		"mediumBitmap"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_SSB_PositionsInBurst, choice.longBitmap),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_ASN_XNAP_longBitmap_constr_4,  memb_ASN_XNAP_longBitmap_constraint_1 },
		0, 0, /* No default value */
		"longBitmap"
		},
	{ ATF_POINTER, 0, offsetof(struct ASN_XNAP_SSB_PositionsInBurst, choice.choice_extension),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ASN_XNAP_ProtocolIE_Single_Container_14199P67,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"choice-extension"
...
asn_TYPE_descriptor_t asn_DEF_ASN_XNAP_SSB_PositionsInBurst = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_ASN_XNAP_SSB_PositionsInBurst_constr_1, CHOICE_constraint },
