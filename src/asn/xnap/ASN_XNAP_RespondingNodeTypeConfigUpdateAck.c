...
static asn_per_constraints_t asn_PER_type_ASN_XNAP_RespondingNodeTypeConfigUpdateAck_constr_1 GCC_NOTUSED = {
...
static asn_TYPE_tag2member_t asn_MAP_ASN_XNAP_RespondingNodeTypeConfigUpdateAck_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ng-eNB at 2985 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* gNB at 2986 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* choice-extension at 2987 */
};
...
asn_TYPE_descriptor_t asn_DEF_ASN_XNAP_RespondingNodeTypeConfigUpdateAck = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_PER_type_ASN_XNAP_RespondingNodeTypeConfigUpdateAck_constr_1,
