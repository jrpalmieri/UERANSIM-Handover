...
static asn_per_constraints_t asn_PER_type_ASN_XNAP_RespondingNodeTypeConfigUpdateAck_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  2 }	/* (0..2) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_ASN_XNAP_RespondingNodeTypeConfigUpdateAck_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct ASN_XNAP_RespondingNodeTypeConfigUpdateAck, choice.choice_extension),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ASN_XNAP_ProtocolIE_Single_Container_14199P3,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"choice-extension"
...
static asn_CHOICE_specifics_t asn_SPC_ASN_XNAP_RespondingNodeTypeConfigUpdateAck_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_ASN_XNAP_RespondingNodeTypeConfigUpdateAck = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_ASN_XNAP_RespondingNodeTypeConfigUpdateAck_constr_1, CHOICE_constraint },
