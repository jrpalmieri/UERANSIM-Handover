...
static asn_per_constraints_t asn_PER_type_ASN_XNAP_ServedCellsToActivate_constr_1 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_ASN_XNAP_ServedCellsToActivate_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct ASN_XNAP_ServedCellsToActivate, choice.choice_extension),
		...
		&asn_DEF_ASN_XNAP_ProtocolIE_Single_Container_14199P6,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"choice-extension"
...
static const asn_TYPE_tag2member_t asn_MAP_ASN_XNAP_ServedCellsToActivate_tag2el_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_ASN_XNAP_ServedCellsToActivate = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_ASN_XNAP_ServedCellsToActivate_constr_1, CHOICE_constraint },
