...
static int
memb_ASN_XNAP_oneframe_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_ASN_XNAP_fourframes_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	const BIT_STRING_t *st = (const BIT_STRING_t *)sptr;
	size_t size;
...
static asn_per_constraints_t asn_PER_memb_ASN_XNAP_oneframe_constr_2 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  6,  6 }	/* (SIZE(6..6)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_ASN_XNAP_fourframes_constr_3 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
...
asn_TYPE_member_t asn_MBR_ASN_XNAP_MBSFNSubframeAllocation_E_UTRA_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_MBSFNSubframeAllocation_E_UTRA, choice.oneframe),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_ASN_XNAP_oneframe_constr_2,  memb_ASN_XNAP_oneframe_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_MBSFNSubframeAllocation_E_UTRA, choice.fourframes),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_ASN_XNAP_fourframes_constr_3,  memb_ASN_XNAP_fourframes_constraint_1 },
		0, 0, /* No default value */
		"fourframes"
		},
	{ ATF_POINTER, 0, offsetof(struct ASN_XNAP_MBSFNSubframeAllocation_E_UTRA, choice.choice_extension),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ASN_XNAP_ProtocolIE_Single_Container_14199P36,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"choice-extension"
