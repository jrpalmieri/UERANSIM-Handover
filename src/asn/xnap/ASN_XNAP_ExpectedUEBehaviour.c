...
static asn_TYPE_member_t asn_MBR_ASN_XNAP_ExpectedUEBehaviour_1[] = {
...
static int asn_MAP_ASN_XNAP_ExpectedUEBehaviour_oms_1[] = { 0, 1, 2, 3, 4 };
static ber_tlv_tag_t asn_DEF_ASN_XNAP_ExpectedUEBehaviour_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_ASN_XNAP_ExpectedUEBehaviour_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* expectedUEActivityBehaviour at 6774 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* expectedHOInterval at 6775 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* expectedUEMobility at 6776 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* expectedUEMovingTrajectory at 6777 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* iE-Extensions at 6778 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ASN_XNAP_ExpectedUEBehaviour_specs_1 = {
