...
static asn_TYPE_member_t asn_MBR_ASN_XNAP_BroadcastPLMNinTAISupport_Item_1[] = {
...
static int asn_MAP_ASN_XNAP_BroadcastPLMNinTAISupport_Item_oms_1[] = { 2 };
static ber_tlv_tag_t asn_DEF_ASN_XNAP_BroadcastPLMNinTAISupport_Item_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_ASN_XNAP_BroadcastPLMNinTAISupport_Item_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* plmn-id at 5091 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* tAISliceSupport-List at 5092 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* iE-Extension at 5093 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ASN_XNAP_BroadcastPLMNinTAISupport_Item_specs_1 = {
