...
static asn_TYPE_member_t asn_MBR_ASN_XNAP_NPRACHConfiguration_TDD_1[] = {
...
static int asn_MAP_ASN_XNAP_NPRACHConfiguration_TDD_oms_1[] = { 2, 3, 4 };
static ber_tlv_tag_t asn_DEF_ASN_XNAP_NPRACHConfiguration_TDD_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_ASN_XNAP_NPRACHConfiguration_TDD_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* nprach-preambleFormat at 8916 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* anchorCarrier-NPRACHConfigTDD at 8917 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* non-anchorCarrierFequencyConfiglist at 8918 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* non-anchorCarrier-NPRACHConfigTDD at 8919 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* iE-Extensions at 8920 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ASN_XNAP_NPRACHConfiguration_TDD_specs_1 = {
