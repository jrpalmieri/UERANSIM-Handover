...
static asn_per_constraints_t asn_PER_type_ASN_XNAP_UERLFReportContainer_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  2 }	/* (0..2) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_ASN_XNAP_UERLFReportContainer_1[] = {
...
static asn_TYPE_tag2member_t asn_MAP_ASN_XNAP_UERLFReportContainer_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* nR-UERLFReportContainer at 13039 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* lTE-UERLFReportContainer at 13040 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* choice-Extension at 13041 */
};
static asn_CHOICE_specifics_t asn_SPC_ASN_XNAP_UERLFReportContainer_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_ASN_XNAP_UERLFReportContainer = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_PER_type_ASN_XNAP_UERLFReportContainer_constr_1,
