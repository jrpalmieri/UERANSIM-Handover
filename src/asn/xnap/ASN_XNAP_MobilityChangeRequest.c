...
asn_TYPE_member_t asn_MBR_ASN_XNAP_MobilityChangeRequest_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_MobilityChangeRequest, protocolIEs),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ASN_XNAP_ProtocolIE_Container_14197P65,
		0,
		{ 0, 0, 0 },
...
asn_SEQUENCE_specifics_t asn_SPC_ASN_XNAP_MobilityChangeRequest_specs_1 = {
