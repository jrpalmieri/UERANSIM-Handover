...
asn_TYPE_member_t asn_MBR_ASN_XNAP_NRCarrierItem_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_NRCarrierItem, offsetToCarrier),
		...
		0,
		{ 0, &asn_PER_memb_ASN_XNAP_offsetToCarrier_constr_3,  memb_ASN_XNAP_offsetToCarrier_constraint_1 },
		0, 0, /* No default value */
		"offsetToCarrier"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_NRCarrierItem, carrierBandwidth),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_ASN_XNAP_carrierBandwidth_constr_4,  memb_ASN_XNAP_carrierBandwidth_constraint_1 },
		0, 0, /* No default value */
		"carrierBandwidth"
		},
	{ ATF_POINTER, 1, offsetof(struct ASN_XNAP_NRCarrierItem, iE_Extension),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ASN_XNAP_ProtocolExtensionContainer_14246P279,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extension"
