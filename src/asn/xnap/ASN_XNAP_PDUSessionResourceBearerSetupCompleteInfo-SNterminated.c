...
static int
memb_ASN_XNAP_dRBsToBeSetupList_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_type_ASN_XNAP_dRBsToBeSetupList_constr_2 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 5,  5,  1,  32 }	/* (SIZE(1..32)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_ASN_XNAP_dRBsToBeSetupList_constr_2 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 5,  5,  1,  32 }	/* (SIZE(1..32)) */,
	0, 0	/* No PER value map */
};
...
static ber_tlv_tag_t asn_DEF_ASN_XNAP_dRBsToBeSetupList_tags_2[] = {
...
asn_TYPE_descriptor_t asn_DEF_ASN_XNAP_dRBsToBeSetupList_2 = {
	...
	&asn_PER_type_ASN_XNAP_dRBsToBeSetupList_constr_2,
	asn_MBR_ASN_XNAP_dRBsToBeSetupList_2,
	1,	/* Single element */
	&asn_SPC_ASN_XNAP_dRBsToBeSetupList_specs_2	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ASN_XNAP_PDUSessionResourceBearerSetupCompleteInfo_SNterminated_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_PDUSessionResourceBearerSetupCompleteInfo_SNterminated, dRBsToBeSetupList),
		...
		memb_ASN_XNAP_dRBsToBeSetupList_constraint_1,
		&asn_PER_memb_ASN_XNAP_dRBsToBeSetupList_constr_2,
		0,
		"dRBsToBeSetupList"
		},
...
static int asn_MAP_ASN_XNAP_PDUSessionResourceBearerSetupCompleteInfo_SNterminated_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_ASN_XNAP_PDUSessionResourceBearerSetupCompleteInfo_SNterminated_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_ASN_XNAP_PDUSessionResourceBearerSetupCompleteInfo_SNterminated_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dRBsToBeSetupList at 10311 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* iE-Extensions at 10312 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ASN_XNAP_PDUSessionResourceBearerSetupCompleteInfo_SNterminated_specs_1 = {
