 ...
 */
static asn_per_constraints_t asn_PER_type_ASN_XNAP_PSCellHistoryInformationRetrieve_constr_1 CC_NOTUSED = {
...
static const asn_INTEGER_specifics_t asn_SPC_ASN_XNAP_PSCellHistoryInformationRetrieve_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_ASN_XNAP_PSCellHistoryInformationRetrieve = {
	...
	sizeof(asn_DEF_ASN_XNAP_PSCellHistoryInformationRetrieve_tags_1)
		/sizeof(asn_DEF_ASN_XNAP_PSCellHistoryInformationRetrieve_tags_1[0]), /* 1 */
	{ 0, &asn_PER_type_ASN_XNAP_PSCellHistoryInformationRetrieve_constr_1, NativeEnumerated_constraint },
