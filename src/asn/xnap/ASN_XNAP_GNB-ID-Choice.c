...
static int
memb_ASN_XNAP_gnb_ID_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_ASN_XNAP_gnb_ID_constr_2 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_ASN_XNAP_GNB_ID_Choice_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_GNB_ID_Choice, choice.gnb_ID),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_ASN_XNAP_gnb_ID_constr_2,  memb_ASN_XNAP_gnb_ID_constraint_1 },
	...
	{ ATF_POINTER, 0, offsetof(struct ASN_XNAP_GNB_ID_Choice, choice.choice_extension),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ASN_XNAP_ProtocolIE_Single_Container_14199P23,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"choice-extension"
