...
static asn_TYPE_member_t asn_MBR_ASN_XNAP_RRCSetup_initiated_1[] = {
...
static int asn_MAP_ASN_XNAP_RRCSetup_initiated_oms_1[] = { 1, 2 };
static ber_tlv_tag_t asn_DEF_ASN_XNAP_RRCSetup_initiated_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_ASN_XNAP_RRCSetup_initiated_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rRRCSetup-Initiated-Reporting at 11268 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* uERLFReportContainer at 11269 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* iE-Extensions at 11270 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ASN_XNAP_RRCSetup_initiated_specs_1 = {
