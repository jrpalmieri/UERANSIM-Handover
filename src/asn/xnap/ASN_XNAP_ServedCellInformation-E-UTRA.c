...
asn_TYPE_descriptor_t asn_DEF_ASN_XNAP_broadcastPLMNs_6 = {
	...
	{ 0, &asn_PER_type_ASN_XNAP_broadcastPLMNs_constr_6, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_ASN_XNAP_freqBandIndicatorPriority_13 = {
	...
	{ 0, &asn_PER_type_ASN_XNAP_freqBandIndicatorPriority_constr_13, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_ASN_XNAP_bandwidthReducedSI_17 = {
	...
	{ 0, &asn_PER_type_ASN_XNAP_bandwidthReducedSI_constr_17, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_ASN_XNAP_ServedCellInformation_E_UTRA_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_ServedCellInformation_E_UTRA, broadcastPLMNs),
		...
		0,
		{ 0, &asn_PER_memb_ASN_XNAP_broadcastPLMNs_constr_6,  memb_ASN_XNAP_broadcastPLMNs_constraint_1 },
		0, 0, /* No default value */
		"broadcastPLMNs"
		},
	...
	{ ATF_POINTER, 1, offsetof(struct ASN_XNAP_ServedCellInformation_E_UTRA, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ASN_XNAP_ProtocolExtensionContainer_14246P437,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
