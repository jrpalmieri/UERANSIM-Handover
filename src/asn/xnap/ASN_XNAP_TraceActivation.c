...
static asn_TYPE_member_t asn_MBR_ASN_XNAP_TraceActivation_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_TraceActivation, interfaces_to_trace),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_ASN_XNAP_interfaces_to_trace_constr_3,  memb_ASN_XNAP_interfaces_to_trace_constraint_1 },
		0, 0, /* No default value */
		"interfaces-to-trace"
		},
	...
	{ ATF_POINTER, 1, offsetof(struct ASN_XNAP_TraceActivation, ie_Extension),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ASN_XNAP_ProtocolExtensionContainer_14246P507,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"ie-Extension"
