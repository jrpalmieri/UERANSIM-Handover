...
static asn_TYPE_member_t asn_MBR_ASN_XNAP_FiveGProSePC5QoSFlowItem_1[] = {
...
static int asn_MAP_ASN_XNAP_FiveGProSePC5QoSFlowItem_oms_1[] = { 1, 2, 3 };
static ber_tlv_tag_t asn_DEF_ASN_XNAP_FiveGProSePC5QoSFlowItem_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_ASN_XNAP_FiveGProSePC5QoSFlowItem_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* fiveGproSepQI at 6983 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* fiveGproSepc5FlowBitRates at 6984 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* fiveGproSerange at 6985 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* iE-Extensions at 6986 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ASN_XNAP_FiveGProSePC5QoSFlowItem_specs_1 = {
