...
static asn_per_constraints_t asn_PER_type_ASN_XNAP_ActivatedServedCells_constr_1 GCC_NOTUSED = {
...
static asn_TYPE_tag2member_t asn_MAP_ASN_XNAP_ActivatedServedCells_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* nr-cells at 3292 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* e-utra-cells at 3293 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* choice-extension at 3294 */
};
...
asn_TYPE_descriptor_t asn_DEF_ASN_XNAP_ActivatedServedCells = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_PER_type_ASN_XNAP_ActivatedServedCells_constr_1,
