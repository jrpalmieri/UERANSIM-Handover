...
static asn_TYPE_member_t asn_MBR_ASN_XNAP_NRPagingeDRXInformationforRRCINACTIVE_1[] = {
...
static int asn_MAP_ASN_XNAP_NRPagingeDRXInformationforRRCINACTIVE_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_ASN_XNAP_NRPagingeDRXInformationforRRCINACTIVE_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_ASN_XNAP_NRPagingeDRXInformationforRRCINACTIVE_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* nRPaging-eDRX-Cycle-Inactive at 9133 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* iE-Extensions at 9134 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ASN_XNAP_NRPagingeDRXInformationforRRCINACTIVE_specs_1 = {
