...
static asn_per_constraints_t asn_PER_type_ASN_XNAP_NPN_Support_constr_1 GCC_NOTUSED = {
...
static asn_TYPE_tag2member_t asn_MAP_ASN_XNAP_NPN_Support_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* sNPN at 8863 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* choice-Extensions at 8864 */
};
...
asn_TYPE_descriptor_t asn_DEF_ASN_XNAP_NPN_Support = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_PER_type_ASN_XNAP_NPN_Support_constr_1,
