...
asn_TYPE_member_t asn_MBR_ASN_XNAP_ENB_ID_Choice_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_ENB_ID_Choice, choice.enb_ID_macro),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_ASN_XNAP_enb_ID_macro_constr_2,  memb_ASN_XNAP_enb_ID_macro_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_ENB_ID_Choice, choice.enb_ID_shortmacro),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_ASN_XNAP_enb_ID_shortmacro_constr_3,  memb_ASN_XNAP_enb_ID_shortmacro_constraint_1 },
		0, 0, /* No default value */
		"enb-ID-shortmacro"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_XNAP_ENB_ID_Choice, choice.enb_ID_longmacro),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_ASN_XNAP_enb_ID_longmacro_constr_4,  memb_ASN_XNAP_enb_ID_longmacro_constraint_1 },
		0, 0, /* No default value */
		"enb-ID-longmacro"
		},
	{ ATF_POINTER, 0, offsetof(struct ASN_XNAP_ENB_ID_Choice, choice.choice_extension),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ASN_XNAP_ProtocolIE_Single_Container_14199P24,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"choice-extension"
