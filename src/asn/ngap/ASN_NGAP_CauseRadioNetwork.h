...
typedef enum ASN_NGAP_CauseRadioNetwork {
	...
	ASN_NGAP_CauseRadioNetwork_redcap_ue_not_supported	= 52,
	ASN_NGAP_CauseRadioNetwork_unknown_MBS_Session_ID	= 53,
	ASN_NGAP_CauseRadioNetwork_indicated_MBS_session_area_information_not_served_by_the_gNB	= 54,
	ASN_NGAP_CauseRadioNetwork_inconsistent_slice_info_for_the_session	= 55,
	ASN_NGAP_CauseRadioNetwork_misaligned_association_for_multicast_unicast	= 56,
	ASN_NGAP_CauseRadioNetwork_eredcap_ue_not_supported	= 57,
	ASN_NGAP_CauseRadioNetwork_two_rx_xr_ue_not_supported	= 58
