...
static asn_per_constraints_t asn_PER_type_ASN_NGAP_AMF_TNLAssociationToAddList_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 5,  5,  1,  32 }	/* (SIZE(1..32)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_ASN_NGAP_AMF_TNLAssociationToAddList_1[] = {
	{ ATF_POINTER, 0, 0,
...
static asn_SET_OF_specifics_t asn_SPC_ASN_NGAP_AMF_TNLAssociationToAddList_specs_1 = {
