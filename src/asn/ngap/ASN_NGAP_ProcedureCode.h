...
#define ASN_NGAP_ProcedureCode_id_TimingSynchronisationStatus	((ASN_NGAP_ProcedureCode_t)76)
#define ASN_NGAP_ProcedureCode_id_TimingSynchronisationStatusReport	((ASN_NGAP_ProcedureCode_t)77)
#define ASN_NGAP_ProcedureCode_id_MTCommunicationHandling	((ASN_NGAP_ProcedureCode_t)78)
#define ASN_NGAP_ProcedureCode_id_RANPagingRequest	((ASN_NGAP_ProcedureCode_t)79)
#define ASN_NGAP_ProcedureCode_id_BroadcastSessionTransport	((ASN_NGAP_ProcedureCode_t)80)
