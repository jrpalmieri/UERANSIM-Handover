...
static asn_TYPE_member_t asn_MBR_ASN_NGAP_EndpointIPAddressAndPort_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct ASN_NGAP_EndpointIPAddressAndPort, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ASN_NGAP_ProtocolExtensionContainer_13606P91,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static asn_SEQUENCE_specifics_t asn_SPC_ASN_NGAP_EndpointIPAddressAndPort_specs_1 = {
