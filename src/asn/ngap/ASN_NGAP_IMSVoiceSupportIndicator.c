 ...
 */
static asn_per_constraints_t asn_PER_type_ASN_NGAP_IMSVoiceSupportIndicator_constr_1 CC_NOTUSED = {
...
static const asn_INTEGER_specifics_t asn_SPC_ASN_NGAP_IMSVoiceSupportIndicator_specs_1 = {
