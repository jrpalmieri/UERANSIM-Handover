...
static asn_per_constraints_t asn_PER_type_ASN_NGAP_NPN_Support_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_ASN_NGAP_NPN_Support_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct ASN_NGAP_NPN_Support, choice.choice_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ASN_NGAP_ProtocolIE_SingleContainer_13558P48,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"choice-Extensions"
...
static asn_CHOICE_specifics_t asn_SPC_ASN_NGAP_NPN_Support_specs_1 = {
