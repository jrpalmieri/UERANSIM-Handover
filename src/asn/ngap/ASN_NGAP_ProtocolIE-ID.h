...
#define ASN_NGAP_ProtocolIE_ID_id_NetworkControlledRepeaterAuthorized	((ASN_NGAP_ProtocolIE_ID_t)367)
#define ASN_NGAP_ProtocolIE_ID_id_AdditionalCancelledlocationReportingReferenceIDList	((ASN_NGAP_ProtocolIE_ID_t)368)
#define ASN_NGAP_ProtocolIE_ID_id_Selected_Target_SNPN_Identity	((ASN_NGAP_ProtocolIE_ID_t)369)
#define ASN_NGAP_ProtocolIE_ID_id_EquivalentSNPNsList	((ASN_NGAP_ProtocolIE_ID_t)370)
#define ASN_NGAP_ProtocolIE_ID_id_SelectedNID	((ASN_NGAP_ProtocolIE_ID_t)371)
#define ASN_NGAP_ProtocolIE_ID_id_SupportedUETypeList	((ASN_NGAP_ProtocolIE_ID_t)372)
#define ASN_NGAP_ProtocolIE_ID_id_AerialUEsubscriptionInformation	((ASN_NGAP_ProtocolIE_ID_t)373)
#define ASN_NGAP_ProtocolIE_ID_id_NR_A2X_ServicesAuthorized	((ASN_NGAP_ProtocolIE_ID_t)374)
#define ASN_NGAP_ProtocolIE_ID_id_LTE_A2X_ServicesAuthorized	((ASN_NGAP_ProtocolIE_ID_t)375)
#define ASN_NGAP_ProtocolIE_ID_id_NR_A2X_UE_PC5_AggregateMaximumBitRate	((ASN_NGAP_ProtocolIE_ID_t)376)
#define ASN_NGAP_ProtocolIE_ID_id_LTE_A2X_UE_PC5_AggregateMaximumBitRate	((ASN_NGAP_ProtocolIE_ID_t)377)
#define ASN_NGAP_ProtocolIE_ID_id_A2X_PC5_QoS_Parameters	((ASN_NGAP_ProtocolIE_ID_t)378)
#define ASN_NGAP_ProtocolIE_ID_id_FiveGProSeLayer2Multipath	((ASN_NGAP_ProtocolIE_ID_t)379)
#define ASN_NGAP_ProtocolIE_ID_id_FiveGProSeLayer2UEtoUERelay	((ASN_NGAP_ProtocolIE_ID_t)380)
#define ASN_NGAP_ProtocolIE_ID_id_FiveGProSeLayer2UEtoUERemote	((ASN_NGAP_ProtocolIE_ID_t)381)
#define ASN_NGAP_ProtocolIE_ID_id_CandidateRelayUEInformationList	((ASN_NGAP_ProtocolIE_ID_t)382)
#define ASN_NGAP_ProtocolIE_ID_id_SuccessfulPSCellChangeReportList	((ASN_NGAP_ProtocolIE_ID_t)383)
#define ASN_NGAP_ProtocolIE_ID_id_IntersystemMobilityFailureforVoiceFallback	((ASN_NGAP_ProtocolIE_ID_t)384)
#define ASN_NGAP_ProtocolIE_ID_id_TargetCellCRNTI	((ASN_NGAP_ProtocolIE_ID_t)385)
#define ASN_NGAP_ProtocolIE_ID_id_TimeSinceFailure	((ASN_NGAP_ProtocolIE_ID_t)386)
#define ASN_NGAP_ProtocolIE_ID_id_RANTimingSynchronisationStatusInfo	((ASN_NGAP_ProtocolIE_ID_t)387)
#define ASN_NGAP_ProtocolIE_ID_id_RAN_TSSRequestType	((ASN_NGAP_ProtocolIE_ID_t)388)
#define ASN_NGAP_ProtocolIE_ID_id_RAN_TSSScope	((ASN_NGAP_ProtocolIE_ID_t)389)
#define ASN_NGAP_ProtocolIE_ID_id_ClockQualityReportingControlInfo	((ASN_NGAP_ProtocolIE_ID_t)390)
#define ASN_NGAP_ProtocolIE_ID_id_RANfeedbacktype	((ASN_NGAP_ProtocolIE_ID_t)391)
#define ASN_NGAP_ProtocolIE_ID_id_QoSFlowTSCList	((ASN_NGAP_ProtocolIE_ID_t)392)
#define ASN_NGAP_ProtocolIE_ID_id_TSCTrafficCharacteristicsFeedback	((ASN_NGAP_ProtocolIE_ID_t)393)
#define ASN_NGAP_ProtocolIE_ID_id_DownlinkTLContainer	((ASN_NGAP_ProtocolIE_ID_t)394)
#define ASN_NGAP_ProtocolIE_ID_id_UplinkTLContainer	((ASN_NGAP_ProtocolIE_ID_t)395)
#define ASN_NGAP_ProtocolIE_ID_id_ANPacketDelayBudgetUL	((ASN_NGAP_ProtocolIE_ID_t)396)
#define ASN_NGAP_ProtocolIE_ID_id_QosFlowAdditionalInfoList	((ASN_NGAP_ProtocolIE_ID_t)397)
#define ASN_NGAP_ProtocolIE_ID_id_AssistanceInformationQoE_Meas	((ASN_NGAP_ProtocolIE_ID_t)398)
#define ASN_NGAP_ProtocolIE_ID_id_MBSCommServiceType	((ASN_NGAP_ProtocolIE_ID_t)399)
#define ASN_NGAP_ProtocolIE_ID_id_MobileIAB_Authorized	((ASN_NGAP_ProtocolIE_ID_t)400)
#define ASN_NGAP_ProtocolIE_ID_id_MobileIAB_MTUserLocationInformation	((ASN_NGAP_ProtocolIE_ID_t)401)
#define ASN_NGAP_ProtocolIE_ID_id_MobileIABNodeIndication	((ASN_NGAP_ProtocolIE_ID_t)402)
#define ASN_NGAP_ProtocolIE_ID_id_NoPDUSessionIndication	((ASN_NGAP_ProtocolIE_ID_t)403)
#define ASN_NGAP_ProtocolIE_ID_id_MobileIAB_Supported	((ASN_NGAP_ProtocolIE_ID_t)404)
#define ASN_NGAP_ProtocolIE_ID_id_CN_MT_CommunicationHandling	((ASN_NGAP_ProtocolIE_ID_t)405)
#define ASN_NGAP_ProtocolIE_ID_id_FiveGCAction	((ASN_NGAP_ProtocolIE_ID_t)406)
#define ASN_NGAP_ProtocolIE_ID_id_PagingPolicyDifferentiation	((ASN_NGAP_ProtocolIE_ID_t)407)
#define ASN_NGAP_ProtocolIE_ID_id_DL_Signalling	((ASN_NGAP_ProtocolIE_ID_t)408)
#define ASN_NGAP_ProtocolIE_ID_id_PNI_NPN_AreaScopeofMDT	((ASN_NGAP_ProtocolIE_ID_t)409)
#define ASN_NGAP_ProtocolIE_ID_id_PNI_NPNBasedMDT	((ASN_NGAP_ProtocolIE_ID_t)410)
#define ASN_NGAP_ProtocolIE_ID_id_SNPN_CellBasedMDT	((ASN_NGAP_ProtocolIE_ID_t)411)
#define ASN_NGAP_ProtocolIE_ID_id_SNPN_TAIBasedMDT	((ASN_NGAP_ProtocolIE_ID_t)412)
#define ASN_NGAP_ProtocolIE_ID_id_SNPN_BasedMDT	((ASN_NGAP_ProtocolIE_ID_t)413)
#define ASN_NGAP_ProtocolIE_ID_id_Partially_Allowed_NSSAI	((ASN_NGAP_ProtocolIE_ID_t)414)
#define ASN_NGAP_ProtocolIE_ID_id_AssociatedSessionID	((ASN_NGAP_ProtocolIE_ID_t)415)
#define ASN_NGAP_ProtocolIE_ID_id_MBS_AssistanceInformation	((ASN_NGAP_ProtocolIE_ID_t)416)
#define ASN_NGAP_ProtocolIE_ID_id_BroadcastTransportFailureTransfer	((ASN_NGAP_ProtocolIE_ID_t)417)
#define ASN_NGAP_ProtocolIE_ID_id_BroadcastTransportRequestTransfer	((ASN_NGAP_ProtocolIE_ID_t)418)
#define ASN_NGAP_ProtocolIE_ID_id_BroadcastTransportResponseTransfer	((ASN_NGAP_ProtocolIE_ID_t)419)
#define ASN_NGAP_ProtocolIE_ID_id_TimeBasedHandoverInformation	((ASN_NGAP_ProtocolIE_ID_t)420)
#define ASN_NGAP_ProtocolIE_ID_id_DLDiscarding	((ASN_NGAP_ProtocolIE_ID_t)421)
#define ASN_NGAP_ProtocolIE_ID_id_PDUsetQoSParameters	((ASN_NGAP_ProtocolIE_ID_t)422)
#define ASN_NGAP_ProtocolIE_ID_id_PDUSetbasedHandlingIndicator	((ASN_NGAP_ProtocolIE_ID_t)423)
#define ASN_NGAP_ProtocolIE_ID_id_N6JitterInformation	((ASN_NGAP_ProtocolIE_ID_t)424)
#define ASN_NGAP_ProtocolIE_ID_id_ECNMarkingorCongestionInformationReportingRequest	((ASN_NGAP_ProtocolIE_ID_t)425)
#define ASN_NGAP_ProtocolIE_ID_id_ECNMarkingorCongestionInformationReportingStatus	((ASN_NGAP_ProtocolIE_ID_t)426)
#define ASN_NGAP_ProtocolIE_ID_id_ERedCapIndication	((ASN_NGAP_ProtocolIE_ID_t)427)
#define ASN_NGAP_ProtocolIE_ID_id_XrDeviceWith2Rx	((ASN_NGAP_ProtocolIE_ID_t)428)
#define ASN_NGAP_ProtocolIE_ID_id_UserPlaneErrorIndicator	((ASN_NGAP_ProtocolIE_ID_t)429)
#define ASN_NGAP_ProtocolIE_ID_id_SLPositioningRangingServiceInfo	((ASN_NGAP_ProtocolIE_ID_t)430)
#define ASN_NGAP_ProtocolIE_ID_id_PDUSessionListMTCommHReq	((ASN_NGAP_ProtocolIE_ID_t)431)
#define ASN_NGAP_ProtocolIE_ID_id_MaximumDataBurstVolume	((ASN_NGAP_ProtocolIE_ID_t)432)
#define ASN_NGAP_ProtocolIE_ID_id_MN_only_MDT_collection	((ASN_NGAP_ProtocolIE_ID_t)433)
#define ASN_NGAP_ProtocolIE_ID_id_MBS_NGUFailureIndication	((ASN_NGAP_ProtocolIE_ID_t)434)
#define ASN_NGAP_ProtocolIE_ID_id_UserPlaneFailureIndication	((ASN_NGAP_ProtocolIE_ID_t)435)
#define ASN_NGAP_ProtocolIE_ID_id_UserPlaneFailureIndicationReport	((ASN_NGAP_ProtocolIE_ID_t)436)
#define ASN_NGAP_ProtocolIE_ID_id_SourceSN_to_TargetSN_QMCInfo	((ASN_NGAP_ProtocolIE_ID_t)437)
#define ASN_NGAP_ProtocolIE_ID_id_QoERVQoEReportingPaths	((ASN_NGAP_ProtocolIE_ID_t)438)
#define ASN_NGAP_ProtocolIE_ID_id_UserLocationInformationN3IWF_without_PortNumber	((ASN_NGAP_ProtocolIE_ID_t)439)
#define ASN_NGAP_ProtocolIE_ID_id_AUN3DeviceAccessInfo	((ASN_NGAP_ProtocolIE_ID_t)440)
#define ASN_NGAP_ProtocolIE_ID_id_TAIMBSSupportList	((ASN_NGAP_ProtocolIE_ID_t)441)
#define ASN_NGAP_ProtocolIE_ID_id_ExtendedBackupAMFName	((ASN_NGAP_ProtocolIE_ID_t)442)
#define ASN_NGAP_ProtocolIE_ID_id_ExtendedOldAMF	((ASN_NGAP_ProtocolIE_ID_t)443)
