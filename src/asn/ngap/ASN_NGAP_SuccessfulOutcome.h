...
typedef enum ASN_NGAP_SuccessfulOutcome__value_PR {
	...
	ASN_NGAP_SuccessfulOutcome__value_PR_BroadcastSessionTransportResponse,
	...
	ASN_NGAP_SuccessfulOutcome__value_PR_MTCommunicationHandlingResponse,
	...
	ASN_NGAP_SuccessfulOutcome__value_PR_TimingSynchronisationStatusResponse,
...
typedef struct ASN_NGAP_SuccessfulOutcome {
	...
	struct ASN_NGAP_SuccessfulOutcome__value {
		...
		union ASN_NGAP_SuccessfulOutcome__value_u {
			...
			ASN_NGAP_BroadcastSessionTransportResponse_t	 BroadcastSessionTransportResponse;
			...
			ASN_NGAP_MTCommunicationHandlingResponse_t	 MTCommunicationHandlingResponse;
			...
			ASN_NGAP_TimingSynchronisationStatusResponse_t	 TimingSynchronisationStatusResponse;
