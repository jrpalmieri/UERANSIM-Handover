...
- docs: documentation files for the repo.  Includes both developer and user documentation.
- src: source code for UE and gNB
    ...
    - ue: UE should code
    - utils: utility functions, available to gNB, UE and CLI
- tests: test harnesses and unit tests for UE and gNB
    - configs: config files for UE and gNB used during tests
    - data: correct (golden) data used for test comparisons
    - gnb: testing code for gnb
    - harness: test infrastructure files that enable the gnb and ue tests
    - ue: testing code for ue
